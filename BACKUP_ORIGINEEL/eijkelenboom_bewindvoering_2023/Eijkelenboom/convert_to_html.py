#!/usr/bin/env python3
"""
PDF naar HTML conversie script voor Eijkelenboom directory
...
def main():
    ...
    base_dir = "/home/herbrand/rechtbank/Eijkelenboom"
    
    print("🔄 PDF naar HTML conversie voor Eijkelenboom directory")
    print("=" * 60)
